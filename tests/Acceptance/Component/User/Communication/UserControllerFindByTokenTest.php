...
class UserControllerFindByTokenTest extends WebTestCase
{
    ...
    public function testFindByTokenNotLoggedIn(): void
    {
    ...
    public function testFindByTokenLoggedInPositiv(): void
    {
        ...
        self::assertSame('admin@cec.valantic.com', $content['email']);
    }

    public function testFindByTokenLoggedInNegativ(): void
    {
        $this->client->jsonRequest('POST',
            $this->apiUrl . '/api/login', [
                'username' => 'admin@cec.valantic.com',
