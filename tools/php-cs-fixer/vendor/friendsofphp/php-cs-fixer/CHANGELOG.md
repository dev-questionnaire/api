...
* minor #1569 Add sample to find a specific version of the fixer (Soullivaneuh)
...
* minor #764 SelfUpdateCommand - find local version only if remote version was successfully obtained (keradus)
